...
export async function up(knex: Knex): Promise<void> {
    await knex.raw(`
        ...
        CREATE TABLE restaurant_branches (
            ...
            commission INT,
            location geography(Point, 4326) GENERATED ALWAYS AS (ST_MakePoint(long::float, lat::float)::geography) STORED,
        ...
        CREATE INDEX idx_restaurant_branches_lat_lng ON restaurant_branches(lat, long);
